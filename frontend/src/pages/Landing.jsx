...
const Landing = () => {
  ...
  return (
    <section
      ref={heroRef}
      className={`relative mx-auto max-w-[1180px] px-5 pb-16 pt-16 text-center  min-h-screen transition-all duration-700 sm:px-8 sm:pb-20 sm:pt-24 lg:px-10 lg:pt-28 ${
        heroInView ? "translate-y-0 opacity-100" : "translate-y-5 opacity-0"
      }`}
    >
      {/* Version Marker */}
      <div
  ...
  "
        style={{
          clipPath:
            "polygon(0 12%, 4% 12%, 4% 4%, 12% 4%, 12% 0, 88% 0, 88% 4%, 96% 4%, 96% 12%, 100% 12%, 100% 88%, 96% 88%, 96% 96%, 88% 96%, 88% 100%, 12% 100%, 12% 96%, 4% 96%, 4% 88%, 0 88%)",
        }}
      >
        <div
          className="
    ...
    "
      ...
      <p className="mx-auto mt-6 max-w-[650px] text-[15px] leading-7 text-[var(--color-text-secondary)] sm:text-base sm:leading-8">
        Create, publish and discover thoughtful content with a modern blogging
        platform built for writers and readers.
      </p>
      ...
      <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
        ...
        <Link to="/home" className="btn-ghost px-6 py-3">
          Explore Feed
        </Link>
      </div>
